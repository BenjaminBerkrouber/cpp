...
/*   Updated: 2024/04/18 18:30:55 by bberkrou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScavTrap::attack(std::string const &target)
{
	if (getHitPoints() == 0)
	{
		std::cout << RED << getName() << " didn't attack because he's dead\n" << RESET << std::endl;
		return ;
	}
	if (getEnergyPoints() > 0)
	{
		...
		std::cout << RED << getName() << " can't be attack because he's doesn't have energy\n" << RESET << std::endl;
}
// ------- Getters --------
