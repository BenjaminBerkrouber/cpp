...
/*   Updated: 2023/12/13 08:43:18 by bberkrou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print_start()
{
	...
	std::cout << " | |    | | __ _ _ __ | |_ __ __ _ _ __  	" << std::endl;
	std::cout << " | |    | |/ _` | '_ \\| | '__/ _` | '_ \\ 	" << std::endl;
	std::cout << " | |____| | (_| | |_) | | | | (_| | |_) |	" << std::endl;
	std::cout << "  \\_____|_|\\__,_| .__/|_|_|  \\__,_| .__/ 	" << std::endl;
	std::cout << "                | |               | |    	" << std::endl;
